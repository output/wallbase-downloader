...
##License
[MIT](https://github.com/victorhaggqvist/wallbase-downloader/blob/master/LICENSE), Use it for whatever you want! Just be aware of that it will most likely break if wallbase changes their layout.
